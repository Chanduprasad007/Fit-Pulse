const muscleMapping = {
  ...
  "chest-supported row": ["Upper Back", "Rear Delts"],
  "straight-arm pulldown": ["Lats"],
  "45-degree back extension": ["Lower Back", "Glutes", "Hamstrings"],
  "ez-bar curl": ["Biceps"],
  ...
  "leg press": ["Quads"],
  "seated dumbbell shoulder press": ["Front Delts", "Side Delts"],
  ...
  "low-incline barbell press": ["Chest"],
  "dumbbell fly": ["Chest"],
  ...
  "machine dip": ["Triceps"],
  "captain's chair knee raise": ["Abs"],
  "bench reverse crunch": ["Abs"],
  "lying leg raise": ["Abs"],
  "machine crunch": ["Abs"],
  "decline weighted sit-up": ["Abs"],
  "stability ball crunch": ["Abs"],
  "trap bar deadlift": ["Lower Back", "Hamstrings", "Glutes"],
  "rack pull": ["Lower Back", "Upper Back"],
  "assisted wide-grip pull-up": ["Lats", "Upper Back"],
  "neutral-grip pulldown": ["Lats", "Upper Back"],
  "machine high row": ["Lats", "Upper Back"],
  "seated cable row": ["Upper Back", "Lats"],
  "one-arm dumbbell row": ["Upper Back", "Lats"],
  "cable pullover": ["Lats"],
  ...
  "body saw": ["Abs"],
  "weighted crunch": ["Abs"],
  "assisted pull-up": ["Lats", "Upper Back"],
  "iso-lateral row machine": ["Upper Back", "Lats"],
  "hip thrust": ["Glutes"],
  "cross-body hammer curl": ["Biceps", "Forearms"],
  "reverse curl": ["Forearms", "Biceps"],
  "russian twist": ["Abs"],
  "side plank rotation": ["Abs"],
  "standing overhead press": ["Front Delts"],
  "landmine press": ["Front Delts"],
  "lean-away lateral raise": ["Side Delts"],
  "incline rear delt raise": ["Rear Delts"],
  "dumbbell shrug": ["Traps"],
  "smith machine shrug": ["Traps"],
  "trap bar shrug": ["Traps"],
  "nordic curl": ["Hamstrings"],
  "suitcase carry": ["Core"],
  "trap bar carry": ["Core", "Traps"],
  "dumbbell hold": ["Core", "Forearms"],
  "mcgill curl-up": ["Abs"]
};
...
function ex(name, sets, reps, rest, tag, cue, alternatives) {
  ...
  const targetMuscles = muscleMapping[normalized] || [];
  return { name, sets, reps, rest, tag, cue, alternatives, targetMuscles };
}
...
export { coachingRules, focusTags, program, muscleMapping };
